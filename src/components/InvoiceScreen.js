...
const InvoiceScreen = ()=>{
           ...
           <Col sm={10}  className="chartRow2">
               ...
               <div style={{paddingTop:30, fontSize:20, paddingLeft:20}}>Invoice Summary</div>
                ...
                {invoices && invoices.map(invoice=>{
                    return(
                        <div style={{backgroundColor:"blue", marginTop:30, marginLeft:30, paddingLeft:20, width:"22%", borderWidth:2}}>
  ...
  <Row>
    ...
    <Col xs={4}>
    <div style={{backgroundColor:"white",  marginTop:73, height:"80%", marginLeft:30, paddingLeft:10, paddingTop:20, paddingBottom:60, display:"flex", flex:3, width:"83%", display:"flex", justifyContent:"center", alignItems:"center"}}>
      <PieScreen/> 
      </div>
    </Col>
  </Row>
      ...
      {/* <div style={{width:"90%", height:1, backgroundColor:"#DEDDDE", marginTop:20}}/> */}
        ...
        <div style={{display:"flex",flexDirection:"row", height:"35%", marginTop:20, marginBottom:50}}>
            ...
            <div style={{backgroundColor:"white", marginLeft:50, width:"34%", padding:50}}>
